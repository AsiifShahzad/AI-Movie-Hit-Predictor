...
echo ""
echo "💡 Tip: Use the new step-by-step scripts for easier deployment:"
echo "  - bash step3-get-account-id.sh"
echo "  - bash step4-create-ecr.sh"
echo "  - bash step5-push-to-ecr.sh"
